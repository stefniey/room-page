                ...
                ? "grid grid-cols-1 lg:grid-cols-2 lg:place-items-center":"hidden"}>
                    ...
                    <div className="relative">
                        ...
                        <ul className="absolute -bottom-3 right-0 flex">
                            <li>
                                <button  onClick={previousSlide}  className="bg-black hover:bg-neutral-700 transition-all duration-200"><img src={left} alt=""  className="p-5"/></button>
                                </li>
                            <li>
                                <button onClick={nextSlide} className="bg-black hover:bg-neutral-700 transition-all duration-200"><img src={right} alt="" className="p-5" /></button>
                                </li>
                        </ul>
                    </div> 
                    ...
                    <div className="p-8 lg:p-12">
                        ...
                        <button className="flex items-center gap-4 uppercase hover:opacity-75" style={{
                            letterSpacing:"0.7rem"

                        }}>
                            Show Now <img src={arrow} alt="" /></button>
                    </div>
                    </article>
            ))}
        </section>
